<html>
    ...
    <body>
        ...
        <form action="insertcustomer.php" method="POST">
            <b>Customer ID : </b><input type="text" name="cid"required> <br><br>
            <b>First Name : </b><input type="text" name="firstname"required> <br><br>
            <b>Last Name : </b><input type="text" name="lastname"required><br><br>
            <b>Telephone : </b><input type="text" name="telephone"required><br><br>
